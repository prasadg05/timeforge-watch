    ...
    <>
      ...
      <section>
        ...
        <Row className='px-4'>
          {[
            {
              img: "https://5.imimg.com/data5/SELLER/Default/2021/12/UC/PH/CV/35897240/women-watch.jpg"
            },
            {
              img: "https://cdn.shopclues.com/images1/thumbnails/109089/320/320/150550611-109089554-1651653901.jpg"
            },
            {
              img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa-92vaMDrp8EmV5AI-UYU2_nU4oeOCNtdBQ&usqp=CAU"
            }
          ].map((card, idx) => (
            <Col key={idx} lg={4} md={6} sm={12}>
              <div className="card1">
                <div className="image-box">
                  <img src={card.img} alt={`Image-${idx}`} />
                </div>
                <div className="content">
                  ...
                  <p style={{ color: "white" }}>
                    Dodge released the eighth generation of the Charger in March 2024, and besides the four-door version, it also came as a coupe.
                  </p>
                </div>
              </div>
            </Col>
      ...
      <section>
        ...
        <Container>
          <Row className='justify-content-center'>
            <Col md={10}>
              <div className="card1" style={{ height: "600px" }}>
                <div className="image-box">
                  <video
                ...
                <div className="content">
                  <h2 style={{ color: "white" }}>EXPLORE THE WORLD WITH TIMEFORGE..</h2>
                </div>
              </div>
            </Col>
          </Row>
